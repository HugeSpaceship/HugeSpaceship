...
func testConfigFile(t *testing.T) {
	...
	if cfg.LBPApi.EnforceDigest != true {
		t.Error("Unexpected value, expected true", cfg.LBPApi.EnforceDigest)
	}
	if cfg.LBPApi.DigestKey != "test_digestKey" {
		t.Error("Unexpected value", cfg.LBPApi.DigestKey)
	}
	if cfg.LBPApi.AlternateDigestKey != "test_altDigestKey" {
		t.Error("Unexpected value", cfg.LBPApi.AlternateDigestKey)
	}
